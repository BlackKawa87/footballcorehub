  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white font-inter px-4">
      <form className="w-full max-w-sm space-y-4">
        ...
        <input type="text" placeholder="Nome" className="w-full p-2 rounded text-gray-900" />
        ...
        <button type="submit" className="w-full py-2 bg-blue-600 rounded hover:bg-blue-700 transition">Registrar</button>
      </form>
    </div>
  );
};
